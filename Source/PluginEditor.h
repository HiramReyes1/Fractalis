...
public:
    ...
    {
        if (activeNote != midiNote) { activeNote = midiNote; repaint(); }
    }
...
private:
    ...
    {
        int c = 0;
        for (int n = start; n <= end; ++n) if (!isBlackKey(n)) ++c;
        return c;
    }
...
private:
    ...
    // =========================================================================
    juce::Label    lfoTitle;
    juce::Label    lfoRateLabel;    juce::Slider   lfoRateSlider;
    juce::Label    lfoDepthLabel;   juce::Slider   lfoDepthSlider;
    juce::Label    lfoWaveLabel;    juce::ComboBox lfoWaveCombo;
    juce::Label    lfoDestLabel;    juce::ComboBox lfoDestCombo;

    // =========================================================================
    // CONTROLES MOD ENV (panel central fila 2)
    // =========================================================================
    juce::Label    modEnvTitle;
    juce::Label    modEnvAttackLabel;   juce::Slider modEnvAttackSlider;
    juce::Label    modEnvDecayLabel;    juce::Slider modEnvDecaySlider;
    juce::Label    modEnvSustainLabel;  juce::Slider modEnvSustainSlider;
    juce::Label    modEnvReleaseLabel;  juce::Slider modEnvReleaseSlider;
    juce::Label    modEnvAmountLabel;   juce::Slider modEnvAmountSlider;
    juce::Label    modEnvDestLabel;     juce::ComboBox modEnvDestCombo;

    // =========================================================================
    // CONTROLES FILTER (panel derecho fila 2)
    // =========================================================================
    juce::Label    filterTitle;
    juce::Label    filterCutoffLabel;   juce::Slider   filterCutoffSlider;
    juce::Label    filterResLabel;      juce::Slider   filterResSlider;
    juce::Label    filterModeLabel;     juce::ComboBox filterModeCombo;
